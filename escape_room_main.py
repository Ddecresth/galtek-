...
class EscapeRoomGame:
    ...
    def create_game(self, cheat=False):
        ...
        chest.triggers.append(lambda obj, cmd, *args: (cmd == "open") and chest.__setitem__("description", create_chest_description(chest)) and hammer.__setitem__("visble",True))
